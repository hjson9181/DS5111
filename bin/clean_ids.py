#!/usr/bin/env python3
"""filtering stdin for valid youtube id, and print in stdout"""
...
def main():
    """read youtube id from stdin, print valid id, log invalid id"""
    for line in sys.stdin:
        youtube_id = line.strip()
        if re.fullmatch(r"[A-Za-z0-9_-]{11}", youtube_id):
            print(youtube_id)
        else:
            logging.warning("Invalid ID: %s", youtube_id)
